...
## UI Library
Cross platform samples for Xamarin and React Native platforms; providing a set of interfaces that utilizes the native Azure Communication UI library and Azure Communication Services to build a calling experience that features both voice and video calling.

### Xamarin Sample release
[UI Library & Xamarin - Calling Hero Sample v0.2.0](https://github.com/Azure/communication-preview/releases/tag/v0.2.0-xamarin-ui-library)

### React Native Sample release
[UI Library & React Native - Calling Hero Sample v0.1.0](https://github.com/Azure/communication-preview/releases/tag/communication-services-ui-library-react-native-hero-pr-0.1.0)
