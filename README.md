...
- [03/22/2022 - 04/04/2022](releasenotes/2022-04-04.md) - **UI Library** release a new version of the SDK for mobile platforms, zoom over shared content, UI/UX engancementes over device selection, localization and, solve performance issues. **Identity** migrated from using `@azure/core-http` to `@azure/core-rest-pipeline` for the handling of HTTP requests on the ***JS*** library. **Network Traversal** release a new beta version of the SDK for ***Python***. **Chat** update the references of the ***JS*** library.
