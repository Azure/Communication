...
- [03/22/2022 - 04/11/2022](releasenotes/2022-04-11.md) - **UI Library** released a new version of the SDK for mobile platforms ***(iOS & Android)***, zoom over shared content, UI/UX enhancements over device selection, localization and, solve performance issues. **Identity** migrated from using `@azure/core-http` to `@azure/core-rest-pipeline` for the handling of HTTP requests on the ***JS library***. **Network Traversal** released a new beta version of the SDK for Python. **Chat** released a GA version for ***iOS*** and released an update with GA support for push notifications in ***Android***; also, updated the references of the ***JS library***.
